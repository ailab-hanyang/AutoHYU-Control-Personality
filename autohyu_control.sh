#!/bin/bash
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - #
# File name: autohyu_control.sh
# Author: Yuseung Na, Junhee Lee, Seounghoon Park
# Date: 2024.09.10
# Description: Script file for AutoHYU
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - #
...
CAR="hmg"      # hmg, ailab
MODE="real"    # real, carmaker, carla, morai
...
# rte
launch_list+=("sleep ${number_of_launch_files}; source devel/setup.bash; roslaunch --screen launch/rte.launch car:=${CAR} location:=${MAP} mode:=${MODE}")
number_of_launch_files=$((${number_of_launch_files} + 1))

# localization
launch_list+=("sleep ${number_of_launch_files}; source devel/setup.bash; roslaunch --screen src/app/localization/state_estimation/launch/state_estimation.launch location:=${MAP}")
number_of_launch_files=$((${number_of_launch_files} + 1))
