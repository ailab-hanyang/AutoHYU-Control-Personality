 ...
 * @brief       carla vehicle control node hpp file
 * 
 ...
 * 
 */
#ifndef __CARLA_VEHICLE_CONTROL_HPP__
#define __CARLA_VEHICLE_CONTROL_HPP__
#pragma once
...
class VehicleControl : public TaskManager {
    ...
    private:
        ...
        void UpdateCommand(const VehicleState& vehicle_state, const double& steer, const double& gas, const double& brake, const double& accel);
        ...
        // Outputs
        carla_msgs::CarlaEgoVehicleControl o_control_signal_;
        ...
        // Algorithms
        double prior_timestamp_{-1.0};
        double prior_publish_walltimestamp_{0.0};
        double prior_publish_simtimestamp_{0.0};
        double prior_accel_error_{0.0};
        double integration_error_{0.0};
        // Configuration parameters   
        CARLAVehicleControlConfig cfg_;
};

#endif  // __CARLA_VEHICLE_CONTROL_HPP__