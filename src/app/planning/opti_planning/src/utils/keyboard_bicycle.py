...
class Keyboard():
    def __init__(self):
        rospy.init_node('keyboard_object', anonymous=True)
        self.vehicle_state_publisher = rospy.Publisher('app/con/target_state', VehicleState, queue_size=5)
    ...
    def run(self):
        ...
        while not rospy.is_shutdown():
            ...
            self.vehicle_state.operation_mode = True
            self.vehicle_state_publisher.publish( self.vehicle_state )
