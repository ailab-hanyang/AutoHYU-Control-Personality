...
#include "acados_solver_integrate_kinematic_bicycle_nmpc.h"
#include <vector>

class IntegrateKinematicBicycleNMPCAcadosWrapper {
    public:
        IntegrateKinematicBicycleNMPCAcadosWrapper(const double& time_step);
        ~IntegrateKinematicBicycleNMPCAcadosWrapper();
    ...
    private:
        integrate_kinematic_bicycle_nmpc_solver_capsule* acados_ocp_capsule;
