#ifndef __INTEGRATE_DYANMIC_BICYCLE_NMPC_HPP__
#define __INTEGRATE_DYANMIC_BICYCLE_NMPC_HPP__
#pragma once
...
class IntegrateDynamicBicycleNMPC: public ControllerInterface{	
	public:
        explicit IntegrateDynamicBicycleNMPC();
        virtual ~IntegrateDynamicBicycleNMPC();
	...
	private:
        ...
        // acados
        std::unique_ptr<IntegrateDynamicBicycleNMPCAcadosWrapper> solver_;
	    // - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - //
	    // Functions
		...
		IntegrateDynamicBicycleNMPCParams params_;
...
#endif  // __INTEGRATE_DYANMIC_BICYCLE_NMPC_HPP__
