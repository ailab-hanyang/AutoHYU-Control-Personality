/**
 * @file        integrate_control.hpp
 * @brief       integrate control node
 * 
 * @authors     Junhee Lee (998jun@gmail.com)         
 */

#ifndef __INTEGRATE_CONTROL_NODE_HPP__
#define __INTEGRATE_CONTROL_NODE_HPP__
#pragma once
...
class ControlNode : public TaskManager {
    public:
        // Constructor
        explicit ControlNode(std::string task_node, double period);
        // Destructor
        virtual ~ControlNode();
    ...
    private:
        ...
        void UpdatePredictedTrajectory(const ControlCommand& cmd);
        ...
        ros::Publisher p_predicted_trajectory_;
        ...
        autohyu_msgs::Trajectory o_predicted_trajectory_;
        ...
        // Algorithm
        std::unique_ptr<Control> ptr_integrate_control_;
...
#endif  // __INTEGRATE_CONTROL_NODE_HPP__