#ifndef __LONGITUDINAL_DYMAMIC_LMPC_HPP__
#define __LONGITUDINAL_DYMAMIC_LMPC_HPP__
#pragma once
...
class LongitudinalDynamicLMPC: public LongitudinalControllerInterface{	
	public:
        explicit LongitudinalDynamicLMPC();
        virtual ~LongitudinalDynamicLMPC();
	...
	private:
		...
		LongitudinalDynamicLMPCParams params_;
