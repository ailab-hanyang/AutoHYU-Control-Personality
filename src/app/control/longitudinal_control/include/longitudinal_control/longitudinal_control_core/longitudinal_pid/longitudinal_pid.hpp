#ifndef __LONGITUDINAL_PUREPURSUIT_HPP__
#define __LONGITUDINAL_PUREPURSUIT_HPP__
#pragma once
...
class LongitudinalPID: public LongitudinalControllerInterface{	
	public:
        explicit LongitudinalPID();
        virtual ~LongitudinalPID();
