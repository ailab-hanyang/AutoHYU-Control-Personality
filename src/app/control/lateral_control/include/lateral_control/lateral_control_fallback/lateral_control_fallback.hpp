#ifndef _LATERAL_CONTROL_FALLBACK_HPP_
#define _LATERAL_CONTROL_FALLBACK_HPP_
...
class LateralControlFallback
{
    public:
        explicit LateralControlFallback();
        virtual ~LateralControlFallback();
...
#endif  // _LATERAL_CONTROL_FALLBACK_HPP_
